...
# view.py
# UI layer: I present Windows, dialogs, and wire user actions to the controller.
import sys
...
class RuleEditorDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, rule=None, is_global=False):
        ...
        self.cboAnimType.addItems(["none", "rainbow", "pulse", "fade"])
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _show_about(self):
        QtWidgets.QMessageBox.about(
            self,
            "About - Animated Windows Borders",
